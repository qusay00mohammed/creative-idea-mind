...
@section('page-title', 'Admin Dashboard 2')
                        ...
                        <div class="mt-comments">
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar1.jpg') }}" /> </div>
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar6.jpg') }}" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar8.jpg') }}" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar4.jpg') }}" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                    ...
                    <div class="events-content">
                        <ol>
                            <li class="selected" data-date="16/01/2014">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar80_3.jpg') }}" />
                                    </div>
                            ...
                            <li data-date="30/08/2014">
                                ...
                                <div class="clearfix"></div>
                                <div class="mt-content border-grey-steel">
                                    <img class="timeline-body-img pull-left" src="{{ asset('assets/admin-rtl/pages/media/blog/5.jpg') }}" alt="">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                        qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                        qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                    ...
                    <div class="events-content">
                        <ol>
                            ...
                            <li data-date="03/03/2015">
                                ...
                                <div class="mt-author">
                                    <div class="mt-avatar">
                                        <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar80_2.jpg') }}" />
                                    </div>
                                    <div class="mt-author-name">
                                        <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                    </div>
            ...
            <div class="portlet-body">
                ...
                <div class="table-scrollable table-scrollable-borderless">
                    <table class="table table-hover table-light">
                        ...
                        <tr>
                            <td class="fit">
                                <img class="user-pic rounded" src="{{ asset('assets/admin-rtl/pages/media/users/avatar4.jpg') }}"> </td>
                            <td>
                        ...
                        <tr>
                            <td class="fit">
                                <img class="user-pic rounded" src="{{ asset('assets/admin-rtl/pages/media/users/avatar5.jpg') }}"> </td>
                            <td>
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                <div id="region_statistics_loading">
                    <img src="{{ asset('assets/admin-rtl/global/img/loading.gif') }}" alt="loading" /> </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="mt-widget-1">
                            ...
                            <div class="mt-img">
                                <img src="{{ asset('assets/admin-rtl/pages/media/users/avatar80_8.jpg') }}"> </div>
                            <div class="mt-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mt-widget-2">
                            <div class="mt-head" style="background-image: url({{ asset('assets/admin-rtl/pages/img/background/32.jpg') }});">
                                <div class="mt-head-label">
                                    <button type="button" class="btn btn-success">Manhattan</button>
                                </div>
                                <div class="mt-head-user">
                                    <div class="mt-head-user-img">
                                        <img src="{{ asset('assets/admin-rtl/pages/img/avatars/team7.jpg') }}"> </div>
                    ...
                    <div class="col-md-6">
                        <div class="mt-widget-2">
                            <div class="mt-head" style="background-image: url({{ asset('assets/admin-rtl/pages/img/background/43.jpg') }});">
                                <div class="mt-head-label">
                                    <button type="button" class="btn btn-danger">London</button>
                                </div>
                                <div class="mt-head-user">
                                    <div class="mt-head-user-img">
                                        <img src="{{ asset('assets/admin-rtl/pages/img/avatars/team3.jpg') }}"> </div>
                                    <div class="mt-head-user-info">
...
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/amcharts.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/serial.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/pie.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/radar.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/themes/light.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/themes/patterns.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amcharts/themes/chalk.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/ammap/ammap.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/ammap/maps/js/worldLow.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/amcharts/amstockcharts/amstock.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/fullcalendar/fullcalendar.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/horizontal-timeline/horizontal-timeline.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('assets/admin/global/plugins/flot/jquery.flot.categories.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jquery.sparkline.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/jquery.vmap.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js') }}" type="text/javascript"></script>
@stop
